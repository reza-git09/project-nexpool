    ...
    <main class="main">
        ...
        <section class="content">
            ...
            <div class="info-box">
                ...
                <i class="fa-solid fa-star" style="color:#eab308;font-size:18px;"></i> <strong>Informasi Review</strong>
                ...
                @else
                    ...
                    <div class="empty">
                        ...
                        <div class="empty-icon">
                            <i class="fa-solid fa-star" style="color:#eab308;font-size:18px;"></i>
                        </div>
